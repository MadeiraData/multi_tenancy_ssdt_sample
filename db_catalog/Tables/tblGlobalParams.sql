...
(
    ...
    [TenantUID] UNIQUEIDENTIFIER NULL CONSTRAINT FK_tblGlobalParams_TenantUID FOREIGN KEY REFERENCES dbo.tblTenants (TenantUID) ON DELETE CASCADE ON UPDATE CASCADE
)
GO
